...
In the next step, I use the selectogadget in chrome extension market to find out the xml path to the two variables of my target i.e. car name and car price range.
